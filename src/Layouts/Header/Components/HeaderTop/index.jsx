    ...
    <div className="header__header-top">
      <div className="__global-container">
        ...
        <div className="header__btns-profile">
          {auth ? (
            <div className="header__box-setting">
              <button onClick={logoutHandler} className="header__logout-button">
                Logout account
              </button>
            </div>
          ) : null}
          <button className="header__btn header__btn--account">
            {auth ? (
              <svg
                className="header__account-setting"
                xmlns="http://www.w3.org/2000/svg"
                height="24px"
                viewBox="0 -960 960 960"
                width="24px"
            ...
            <small className="header__btn-text">
