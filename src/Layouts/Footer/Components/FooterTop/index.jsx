                ...
                <div className="footer__top_container __global-container">
                    <div className="footer__top_box">
                        ...
                        <ul className="footer__top_box-list">
                            <li className="footer__top_box-item">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Minima ducimus atque, necessitatibus reprehenderit quidem quam! Asperiores, nobis qui.</li>
                            <li className="footer__top_box-item">
